    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submitButton.setOnClickListener( (OnClickListener) (new OnClickListener() {
            public final void onClick(View it) {
                ...
                if ( score > 60 ) {
                    Toast.makeText( getApplicationContext(), "You passed! Your score {" + score + '}', Toast.LENGTH_LONG ).show();
                }
                else {
                    Toast.makeText( getApplicationContext(), "You failed! Your score " + score, Toast.LENGTH_LONG ).show();
                }
